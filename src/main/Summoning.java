...
public class Summoning {
	...
	public final static String[] FAMILIAR_NAMES = { "Spirit wolf", "Dreadfowl",
		"Meerkats", "Spirit spider", "Thorny snail", "Granite crab",
		"Spirit mosquito", "Desert wyrm", "Spirit scorpion",
		"Spirit Tz-Kih", "Albino rat", "Spirit kalphite", "Compost mound",
		"Giant chinchompa", "Vampyre bat", "Honey badger", "Beaver",
		"Void ravager", "Void spinner", "Void shifter", "Void torcher",
		"Bronze minotaur", "Bull ant", "Macaw", "Evil Turnip",
		"Spirit cockatrice", "Spirit guthatrice", "Spirit saratrice",
		"Spirit zamatrice", "Spirit pengatrice", "Spirit coraxatrice",
		"Spirit vulatrice", "Iron minotaur", "Pyrelord", "Magpie",
		"Bloated leech", "Spirit terrorbird", "Abyssal parasite",
		"Spirit jelly", "Steel minotaur", "Ibis", "Spirit graahk",
		"Spirit kyatt", "Spirit larupia", "Karamthulhu overlord",
		"Smoke devil", "Abyssal lurker", "Spirit cobra", "Stranger plant",
		...
		"Fire titan", "Ice titan", "Moss titan", "Hydra",
		"Spirit dagannoth", "Lava titan", "Swamp titan", "Rune minotaur",
		"Ghast familiar", "Unicorn stallion", "Geyser titan",
		"Wolpertinger", "Abyssal titan", "Iron titan", "Pack yak",
		"Steel titan" };
	...
	public static int getPoints() {
		return Integer.parseInt(Widgets.get(WIDGET_SUMMONING_ORB, 7).getText());
	}
	...
	public static boolean isFamiliarSummoned() {
		return getTimeLeft() > 0 && Settings.get(1786) > 0;
	}
	 ...
	 * Changed from getting ID to getting name.
	 *
	 * @return NPC type of currently summoned familiar.
	 */
	public static final NPC getFamiliar() {
		if (!isFamiliarSummoned()) {
			System.out.println("[SEVERE]No Familiar Summoned");
			return null;
		}
		return NPCs.getNearest(new Filter<NPC>() {
			@Override
			public boolean accept(NPC npc) {
				for(String name : FAMILIAR_NAMES) {
					return npc.getInteracting() != null && npc.getName().contains(name) && 
